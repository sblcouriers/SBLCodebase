...
namespace Sbl.Helpers
{
    ...
    public class AuthorizationHeaderHandler : DelegatingHandler
    {
        ...
        protected override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            // Verification.
            if (request.Headers.TryGetValues(WebConstant.ApiConstant.API_KEY_HEADER, out apiKeyHeaderValues) &&
                !string.IsNullOrEmpty(authorization.Parameter))
            {
                ...
                // Verification.
                if (apiKeyHeaderValue.Equals(WebConstant.ApiConstant.API_KEY_VALUE) &&
                    userName.Equals(WebConstant.ApiConstant.USERNAME_VALUE) &&
                    password.Equals(WebConstant.ApiConstant.PASSWORD_VALUE))
                {
                    // Setting
